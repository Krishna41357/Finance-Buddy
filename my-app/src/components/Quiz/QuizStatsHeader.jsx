    ...
    <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
        <div className="text-center">
          <div className="text-2xl font-bold text-green-600">{currentQuestion + 1}</div>
        ...
        <div className="text-center">
          <div className="text-2xl font-bold text-green-800">{totalQuestions - answeredCount}</div>
          <div className="text-sm text-gray-500">Remaining</div>
        </div>
        <div className="text-center">
          <div className="text-2xl font-bold text-green-900">{formatTime(timeLeft)}</div>
